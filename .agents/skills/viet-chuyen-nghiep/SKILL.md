...
description: >-
  TÒA SOẠN BÁO AI — VIẾT TIẾNG VIỆT CHUYÊN NGHIỆP. Tổng biên tập nhận đề bài
  → phân vai → điều phối 6 ban (Thu thập, Biên tập, Kiểm duyệt, Xuất bản, Tư
  liệu, Phát triển). Hỗ trợ viết blog, bài phản bác, tài liệu kỹ thuật, phân
  tích data, bài đăng Facebook. Quy trình GATE bàn giao giữa các ban. Kích hoạt
  khi user yêu cầu viết bài, viết blog, viết content, soạn bài, viết debunk,
  phản bác, viết status Facebook. KHÔNG dùng cho dịch thuật (→ ejv-translate,
  pdf-translate), viết JD (→ viet-jd), xử lý văn bản hành chính (→ xu-ly-van-phong).
trigger: >-
  Viết bài, viết blog, viết content, soạn bài, viết debunk, phản bác, viết
  status, viết Facebook, viết chuyên nghiệp, tòa soạn, biên tập, editorial
exclusion: >-
  KHÔNG dùng cho dịch thuật (→ ejv-translate, pdf-translate), viết JD (→ viet-jd),
  xử lý văn bản hành chính (→ xu-ly-van-phong).
push: >-
  Dùng cho MỌI yêu cầu viết nội dung tiếng Việt — kể cả khi user chỉ nói
  'viết giùm bài về chủ đề X' mà không nhắc 'chuyên nghiệp'.
---
