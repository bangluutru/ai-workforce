...
# Workflow: Sổ tay Hướng dẫn Người dùng AIWF (Handbook)

> **Mục tiêu:** Mở ngay Cẩm nang Hướng dẫn Vận hành AI Workforce để người dùng mới tìm hiểu và làm quen với hệ thống chỉ bằng 1 cú nhấp chuột.
...
6. **FAQ & Khắc phục sự cố:** Hướng dẫn sửa nhanh các lỗi thường gặp.

## 3. HÀNH ĐỘNG HỆ THỐNG
- Khi người dùng nhấp vào biểu tượng 📖 **Sổ tay AIWF** trên bảng điều khiển Extension:
  - Hệ thống tự động mở file `docs/AIWF_USER_HANDBOOK.md` ở chế độ xem trước (Markdown Preview).
  - Người dùng có thể nhấp vào bất kỳ mục nào trong Mục lục để di chuyển nhanh tới phần nội dung cần xem.
