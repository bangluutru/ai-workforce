...
> Toàn bộ thư mục và tài liệu tuyển dụng PHẢI được tạo tại `<output_dir>` do người dùng chỉ định hoặc **Mặc định: `~/Downloads/Tuyen_Dung_{Mã TD}/`**.
...
## INPUT (Truy ngược)
- **Từ user:** Vị trí cần tuyển, phòng ban, số lượng, lý do tuyển, thư mục lưu kết quả (mặc định: `~/Downloads/`).
